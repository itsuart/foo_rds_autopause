...
DECLARE_COMPONENT_VERSION("Autopause on RDS disconnect", "1.2", "Automatically pauses the playback when Fast User Switch'ing.");


// This will prevent users from renaming your component around (important for proper troubleshooter behaviors) or loading multiple instances of it.
VALIDATE_COMPONENT_FILENAME("foo_rds_autopause-x86.dll");
