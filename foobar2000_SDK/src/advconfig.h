...
public:
	...
	int_t get() const {
        return service_factory_single_t<advconfig_entry_integer_impl_<int_t_> >::get_static_instance().get_state_int();
    }

	void set(int_t val) {
        service_factory_single_t<advconfig_entry_integer_impl_<int_t_> >::get_static_instance().set_state_int(val);
    }
